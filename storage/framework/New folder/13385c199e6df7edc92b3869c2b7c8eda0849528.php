...
<form method="POST">
	...
	<div id="body">
		<ul>
			...
			<li><input type="text" name="tentrungtam_1"></li>
		</ul>
		<br><br>
				...
				<ul>
					<table class="table">
						...
						<tr>
							...
							<td><input type="text" name="tentrungtam_2"></td>
						</tr>
						<tr>
							<td><b>2.Địa chỉ các cơ sở đào tạo:&nbsp</b></td>
							<td><input type="text" name="diachicosodaotao"></td>
						</tr>
						<tr>
						...
						<tr>
							...
							<td><input type="" name="giaovien_nn"></td>
						</tr>
						<tr>
							<td style="padding-left: 30px"><i>8.2 Giáo viên Việt Nam</i></td>
							<td><input type="" name="giaovien_vn"></td>
						</tr>
						<tr>
						...
						<tr>
							...
							<td><input type="" name="hocvien_solop"></td>
						</tr>
						<tr>
						...
						<tr>
							...
							<td><input type="" name="sohocvien_2014"></td>
						</tr>
						<tr>
							<td style="padding-left: 60px">9.2.2 Năm 2015</td>
							<td><input type="" name="sohocvien_2015"></td>
						</tr>
						<tr>
							<td style="padding-left: 60px">9.2.3 Năm 2016</td>
							<td><input type="" name="sohocvien_2016"></td>
						</tr>
						<tr>
							<td style="padding-left: 60px">9.2.4 Năm 2017</td>
							<td><input type="" name="sohocvien_2017"></td>
						</tr>
						<tr>
						...
						<tr>
							...
							<td><input type="" name="csvc_sophonghoc"></td>
						</tr>
						<tr>
