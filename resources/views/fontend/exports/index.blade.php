...
<form method="POST" id="form_m1">
	...
	<div id="body" class="row">
		<div class="col-md-6" id="donvichuquan">
			<ul>
				...
				<li><input required type="text" name="trungtam" size="50">&nbsp</li>
				<br><br>
				<li><label>Số:&nbsp</label></li>
				<li><input required type="" name="so">&nbsp/</li>
				<li><label>BC:&nbsp</label></li>
				<li><input required type="" name="bc"></li>
				<br><br>
		...
		<div class="col-md-6" id="modau">
			...
			<ul>
				...
				<li><p><input required type="" name="ngay" style="width:100px">&nbsp</p></li>
				<li>/tháng&nbsp</li>
				<li><input required type="" name="thang" style="width:100px">&nbsp</li>
				<li><p>/năm&nbsp</p></li>
				<li><input required type="" name="nam" style="width:100px">&nbsp</li>
		...
		<div id="noidung">
			<div class="col-md-12 form-group">
				<h4 align="center"><b>Kính gửi: Sở giáo dục và Đạo tạo Hà Nội</b></h4>
					<ul>
						...
						<li><input required type="text" name="congvan_so">&nbsp</li>
						<li><p>/SGD&ĐT-GDTX-CN ngày &nbsp</p></li>
						<li><p><input required type="" name="congvan_ngay" style="width:100px">&nbsp</p></li>
						<li>tháng&nbsp</li>
						<li><input required type="" name="congvan_thang" style="width:100px">&nbsp</li>
						<li><p>năm&nbsp</p></li>
						<li><input required type="" name="congvan_nam" style="width:100px">&nbsp</li>
						...
						<li><input required type="text" name="" size="50" \>&nbsp</li>
			...
			<div  class="col-md-12 form-group">
				<ul>
					...
					<li><p>Số:&nbsp</p></li>
					<li><input required type="text" name="chungnhan_so">&nbsp</li>
					<li><p>Ngày cấp&nbsp</p></li>
					<li><input required type="text" name="chungnhan_ngaycap" id="chungnhan_ngaycap">&nbsp</li>
					<li>Nơi cấp&nbsp</li>
					<li><input required type="text" name="chungnhan_noicap" size="50px">&nbsp</li>
					<br><br>
					<li><p><b><i>Địa chỉ trụ sở chính:&nbsp</i></b></p></li>
					<li><input required type="text" name="trusochinh_diachi">&nbsp</li>
					<br><br>
					<li><p>ĐT:&nbsp</p></li>
					<li><input required type="" name="trusochinh_dienthoai">&nbsp</li>
					<li><p>Fax:&nbsp</p></li>
					<li><input required type="" name="trusochinh_fax">&nbsp</li>
					<li><p>Email:&nbsp</p></li>
					<li><input required type="email" name="trusochinh_email" size="50px">&nbsp</li>
					<br><br>
					<li><p>Website:&nbsp</p></li>
					<li><input required type="text" name="trusochinh_website" size="100px">&nbsp</li>
					<br><br>
					<li><p>Loại hình doanh nghiệp:&nbsp</p></li>
					<li><input required type="text" name="loaihinhdoanhnghiep" size="100px">&nbsp</li>
					<br><br>
					<li><p>Thời hạn hoạt động:&nbsp</p></li>
					<li><input required type="text" name="thoihan_hoatdong" id="thoihan_hoatdong">&nbsp</li>
					<br><br>
					<li><p>Mã số thuế:&nbsp</p></li>
					<li><input required type="text" name="masothue" size="50px">&nbsp</li>
					<li><p>Vốn đăng ký/điều lệ:&nbsp</p></li>
					<li><input required type="text" name="von_dieule" size="50px">&nbsp VNĐ</li>
					<br><br>
					<li><p>Vón góp thực hiện dự án đăng ký/cho Trung Tâm:&nbsp</p></li>
					<li><input required type="text" name="von_trungtam" size="50px">&nbsp VNĐ</li>
					<br><br>
					<li><b><i>Người đại diện theo pháp luật</i></b></li>
					<br><br>
					<li><p>Họ và tên:&nbsp</p></li>
					<li><input required type="text" name="daidien_hoten">&nbsp</li>
					<li><p>Quốc tịch&nbsp</p></li>
					<li><input required type="text" name="daidien_quoctich">&nbsp</li>
					<br><br>
					<li><p>Điện thoại di động:&nbsp</p></li>
					<li><input required type="" name="daidien_dtdd">&nbsp</li>
					<li><p>Email liên hệ:&nbsp</p></li>
					<li><input required type="email" name="daidien_email" size="50px">&nbsp</li>
					<br><br>
					<li><p>Nơi ở hiện tại:&nbsp</p></li>
					<li><input required type="text" name="daidien_noio" size="100px">&nbsp</li>
					<br><br>
					...
					<li><input required type="text" name="tentrungtam_vn">&nbsp</li>
					<br><br>
					<li><i>(Tiếng anh, tên giao dịch):&nbsp</i></li>
					<li><input required type="text" name="tentrungtam_e">&nbsp</li>
					<br><br>
					<div id="m1_chophep_thanhlap">
						<li><i><b>Quyết định cho phép thành lập</b></i></li>
						<br><br>
						<li><p>Số:&nbsp</p></li>
						<li><input required type="text" name="thanhlap_so">&nbsp</li>
						<li><p>Ngày cấp:&nbsp</p></li>
						<li><input required type="text" name="thanhlap_ngaycap" id="thanhlap_ngaycap_datetimepicker">&nbsp</li>
						<li><p>Nơi cấp:&nbsp</p></li>
						<li><input required type="text" name="thanhlap_noicap" size="50px">&nbsp</li>
					...
					<div id="m1_chophep_hoatdong">
						<li><p>Số:&nbsp</p></li>
						<li><input required type="text" name=hoatdong_so>&nbsp</li>
						<li><p>Ngày cấp:&nbsp</p></li>
						<li><input required type="text" name="hoatdong_ngaycap" id="hoatdong_ngaycap_datetimepicker">&nbsp</li>
						<li><p>Nơi cấp:&nbsp</p></li>
						<li><input required type="text" name="hoatdong_noicap" size="50px">&nbsp</li>
					...
					<br><br>
					<li><p>Họ và tên:&nbsp</p></li>
					<li><input required type="text" name="giamdoc_hoten">&nbsp</li>
					<li><p>Quốc tịch:&nbsp</p></li>
					<li><input required type="text" name="giamdoc_quoctich"></li>
					<br><br>
					<li><p>Điện thoại di động:&nbsp</p></li>
					<li><input required type="" name="giamdoc_dienthoai">&nbsp</li>
					<li><p>Email liên hệ:&nbsp</p></li>
					<li><input required type="email" name="giamdoc_email" size="50px">&nbsp</li>
					<br><br>
					<li><p>Nơi ở hiện tại:&nbsp</p></li>
					<input required type="text" name="giamdoc_noio" size="50px">
					<br><br>
					<li><i><b>Địa chỉ cơ sở đào tạo:&nbsp</b>(Ghi rõ từng cơ sở)&nbsp</i></li>
					<li><input required type="text" name="cosodaotao" size="50px"></li>
					<br><br>
					<li><i><b>Nội dung hoạt động được cấp phép:&nbsp</b>(ghi theo Quyết định/Chứng nhận hoạt động)</i>
					</li>
					<br><br>
					<textarea rows="5" cols="100" name="noidung_hoatdong"></textarea>
					<br><br>
					...
					<textarea rows="5" cols="100" name="vuongmac"></textarea>
					<h5><b>2.6. Đề xuất, kiến nghị với các cơ quan chức năng:</b></h5>
					<textarea rows="5" cols="100" name="kiennghi"></textarea>
				</ul>
				<div>
						<ul>
							...
							<table>
								...
								<tr>
									...
									<td><input required type="number" name="solop"></td>
								</tr>
								<tr>
								...
								<tr>
									...
									<td><input required type="number" name="hocvien_2014"></td>
								</tr>
								<tr>
									<td style="padding-left: 60px">3.2.2.2 Năm 2015</td>
									<td><input required type="number" name="hocvien_2015"></td>
								</tr>
								<tr>
									<td style="padding-left: 60px">3.2.2.3 Năm 2016</td>
									<td><input required type="number" name="hocvien_2016"></td>
								</tr>
								<tr>
									<td style="padding-left: 60px">3.2.2.4 Năm 2017</td>
									<td><input required type="number" name="hocvien_2017"></td>
								</tr>
								<tr>
								...
								<tr>
									...
									<td><input required type="number" name="hocphi_muc1"></td>
								</tr>
								<tr>
									<td style="padding-left: 30px"><i>3.3.2 Mức 2</i></td>
									<td><input required type="number" name="hocphi_muc2"></td>
								</tr>
								<tr>
									<td style="padding-left: 30px"><i>3.3.3 Mức 3</i></td>
									<td><input required type="number" name="hocphi_muc3"></td>
								</tr>
								<tr>
									<td style="padding-left: 30px"><i>3.3.4 Mức 4</i></td>
									<td><input required type="number" name="hocphi_muc4"></td>
								</tr>
								<tr>
								...
								<tr>
									...
									<td><input required type="number" name="csvc_phonghoc"></td>
								</tr>
								<tr>
									<td style="padding-left: 30px"><i>3.4.2. Tổng số phòng chức năng</i></td>
									<td><input required type="number" name="csvc_phongchucnang"></td>
								</tr>
								<tr>
									<td style="padding-left: 30px"><i>3.4.3. Thư viện</i></td>
									<td><input required type="number" name="csvc_thuvien"></td>
								</tr>
							</table>
						</ul>
					</div>
	...
	<div id="footer" class="row">
		...
		<div>
			<button type="submit" class="btn btn-success">Tải lên <span class="glyphicon glyphicon-upload"></span></button>
...
<script type="text/javascript">
	...
	function addfield1() {
		...
		$('#m1_thanhlap_ngaycap2').datetimepicker({
			format: 'd/m/Y',
		});
	...
	function addfield2() {
		...
		'<li><p>Ngày cấp:&nbsp</p></li>'+
		'<li><input required type="text" name="m1_hoatdong_ngaycap2" id="m1_hoatdong_ngaycap2">&nbsp</li>'+
		'<li><p>Nơi cấp:&nbsp</p></li>'+
		...
		$('#m1_hoatdong_ngaycap2').datetimepicker({
			format: 'd/m/Y',
		});
