		...
		<div id="noidung">
			<div class="col-md-12 form-group">
				<h4 align="center"><b>Kính gửi: Sở giáo dục và Đạo tạo Hà Nội</b></h4>
					<ul>
						...
						<li><input required type="text" name="congvanso">&nbsp</li>
						...
						<li><input required type="text" name="trungtam2" size="50" \>&nbsp</li>
			...
			<div  class="col-md-12 form-group">
				<ul>
					...
					<li><input required type="text" name="chungnhan_ngaycap" id="chungnhan_ngaycap_datetimepicker">&nbsp</li>
					<li>Nơi cấp&nbsp</li>
					<li><input required type="text" name="chungnhan_noicap" size="50px">&nbsp</li>
					<br><br>
					<li><p><b><i>Địa chỉ trụ sở chính:&nbsp</i></b></p></li>
					<li><input required type="text" name="trusochinh">&nbsp</li>
					<br><br>
					<li><p>ĐT:&nbsp</p></li>
					...
					<li><input required type="text" name="thoihan" id="thoihan_datetimepicker">&nbsp</li>
					<br><br>
					...
					<li><input required type="text" name="daidien_email" size="50px">&nbsp</li>
					<br><br>
					...
					<br><br>
					<li><p>Số:&nbsp</p></li>
					<li><input required type="text" name=hoatdong_so></li>
					<li><p>Ngày cấp:&nbsp</p></li>
