			...
			<div>
				<ul>
					<table class="table">
						...
						<tr>
							<td style="padding-left: 30px"><input type="radio" name="chucvu" value="quanly"> Quản lý</td>
						</tr>
						<tr>
							<td style="padding-left: 30px"><input type="radio" name="chucvu" value="gv_huuco"> GV Hữu cơ</td>
						</tr>
						<tr>
							<td style="padding-left: 30px"><input type="radio" name="chucvu" value="gv_thinhgiang"> GV Thỉnh giảng</td>
						</tr>
						<tr>
							<td style="padding-left: 30px"><input type="radio" name="chucvu" value="tinhnguyen"> Tình nguyện viên</td>
						</tr>
						<tr>
							<td><b>4.Trình độ:&nbsp</b></td>
						</tr>
						<tr>
							<td style="padding-left: 30px"><input type="radio" name="trinhdo" value="chuyenganh"> Chuyên ngành được đào tạo</td>
						</tr>
						<tr>
							<td style="padding-left: 30px"><input type="radio" name="trinhdo" value="trendaihoc"> Trên đại học</td>
						</tr>
						<tr>
							<td style="padding-left: 30px"><input type="radio" name="trinhdo" value="daihoc"> Đại học</td>
						</tr>
						<tr>
							<td style="padding-left: 30px"><input type="radio" name="trinhdo" value="caodang"> Cao đẳng</td>
						</tr>
						<tr>
							<td style="padding-left: 30px"><input type="radio" name="trinhdo" value="ngoaingu"> Ngoại ngữ</td>
						</tr>
						<tr>
							<td style="padding-left: 30px"><input type="radio" name="trinhdo" value="nghiepvu"> Tên chứng chỉ nghiệp vụ sư phạm</td>
						</tr>
						<tr>
